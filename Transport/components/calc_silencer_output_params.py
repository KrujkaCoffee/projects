OUTPUT_PARAMS = {
    ...
    : {'view': True, 'header':  'Плотность среды, кг/м3', 'dimension': 'кг/м3', 'comment': '', 'group_name': 'Промежуточные расчеты',
    ...
    'r_reaktivnye_sily_n'
    : {'view': True, 'header':  'R, реактивные силы, Н', 'dimension': '', 'comment': '', 'group_name': 'Отдельное окно расчета',
       'formula': {'expr': '=O19^2*O18/E57', 'cell': 'O20'}, 'accuracy': 4},
    'sreda_2'
    : {'view': True, 'header':  'Среда', 'dimension': '', 'comment': 'Дроссельный блок', 'group_name': 'Дроссельный блок',
       'formula': {'expr': '=E9', 'cell': 'O23'}, 'accuracy': 4},
    'rashod_sredy_g_kg_s'
    : {'view': True, 'header':  'Расход среды g, кг/с', 'dimension': 'кг/с', 'comment': '', 'group_name': 'Дроссельный блок',
       'formula': {'expr': '=IF(E10="кг/с",E11,IF(E10="т/ч",ROUNDUP(E11*1000/3600,2)))', 'cell': 'O24'}, 'accuracy': 4},
    'temperatura_sredy_s_2'
    : {'view': True, 'header':  'Температура среды, с', 'dimension': 'с', 'comment': '', 'group_name': 'Дроссельный блок',
    ...
    : {'view': True, 'header':  'Критическая скорость скр, м/с', 'dimension': 'м/с', 'comment': '', 'group_name': 'Дроссельный блок',
       'formula': {'expr': '=(2*O29*(E12+273)*($O$31/($O$31+1)))^0.5', 'cell': 'O28'}, 'accuracy': 4},
    'gazovaya_postoyannaya_m2_s2_k'
    : {'view': True, 'header':  'Газовая постоянная , м2/с2*к', 'dimension': '', 'comment': '', 'group_name': 'Дроссельный блок',
       'formula': {
    ...
    : {'view': True, 'header':  'Значение п дроссельного блока', 'dimension': '', 'comment': '', 'group_name': 'Дроссельный блок',
    ...
    : {'view': True, 'header':  'Количество ступеней дросселирования j', 'dimension': 'шт', 'comment': 'Параметры дроссельного блока',
    ...
    : {'view': True, 'header':  'Максимальное количество отверстий кмах в дроссельной решетке, шт', 'dimension': 'шт', 'comment': '',
       'group_name': 'Параметры дроссельного блока',
    ...
    'stupeni_n1'
    : {'view': True, 'header':  '№ ступени n1', 'dimension': '', 'comment': '', 'group_name': 'Параметры потока в дроссельном блоке',
    ...
    : {'view': True, 'header':  'Газодинамическая функция расхода, q N1', 'dimension': '', 'comment': '',
       ...
       'formula': {
           ...
           'cell': 'O47'}, 'accuracy': 4},
    'oblast_n1'
    : {'view': True, 'header':  'область N1', 'dimension': '', 'comment': '', 'group_name': 'Параметры потока в дроссельном блоке',
       'formula': {'expr': '=IF(AND(O46<1,O46>O144),"Дозвуковая область","Сверхзвуковая область")', 'cell': 'O48'},
       'accuracy': 4},
    'stupeni_n2'
    : {'view': True, 'header':  '№ ступени N2', 'dimension': '', 'comment': '', 'group_name': 'Параметры потока в дроссельном блоке',
    ...
    : {'view': True, 'header':  'Газодинамическая функция расхода, q N2', 'dimension': '', 'comment': '',
       ...
       'formula': {
           ...
           'cell': 'O51'}, 'accuracy': 4},
    'oblast_n2'
    : {'view': True, 'header':  'область N2', 'dimension': '', 'comment': '', 'group_name': 'Параметры потока в дроссельном блоке',
       'formula': {'expr': '=IF(O34=1,"",IF(AND(O50<1,O50>O144),"Дозвуковая область","Сверхзвуковая область"))',
                   'cell': 'O52'}, 'accuracy': 4},
    'stupeni_n3'
    : {'view': True, 'header':  '№ ступени N3', 'dimension': '', 'comment': '', 'group_name': 'Параметры потока в дроссельном блоке',
    ...
    : {'view': True, 'header':  'Газодинамическая функция расхода, q N3', 'dimension': '', 'comment': '',
       ...
       'formula': {
           ...
           'cell': 'O55'}, 'accuracy': 4},
    'oblast_n3'
    : {'view': True, 'header':  'область N3', 'dimension': '', 'comment': '', 'group_name': 'Параметры потока в дроссельном блоке',
       'formula': {'expr': '=IF(O34<3,"",IF(AND(O54<1,O54>O144),"Дозвуковая область","Сверхзвуковая область"))',
                   'cell': 'O56'}, 'accuracy': 4},
    'stupeni_n4'
    : {'view': True, 'header':  '№ ступени N4', 'dimension': '', 'comment': '', 'group_name': 'Параметры потока в дроссельном блоке',
    ...
    : {'view': True, 'header':  'Газодинамическая функция расхода, q N4', 'dimension': '', 'comment': '',
       ...
       'formula': {
           ...
           'cell': 'O59'}, 'accuracy': 4},
    'oblast_n4'
    : {'view': True, 'header':  'область N4', 'dimension': '', 'comment': '', 'group_name': 'Параметры потока в дроссельном блоке',
       'formula': {'expr': '=IF(E17>3,IF(AND(O58<1,O58>O144),"Дозвуковая область","Сверхзвуковая область"),"")',
                   'cell': 'O60'}, 'accuracy': 4},
    'stupeni_n5'
    : {'view': True, 'header':  '№ ступени N5', 'dimension': '', 'comment': '', 'group_name': 'Параметры потока в дроссельном блоке',
    ...
    : {'view': True, 'header':  'Газодинамическая функция расхода, q N5', 'dimension': '', 'comment': '',
       ...
       'formula': {
           ...
           'cell': 'O63'}, 'accuracy': 4},
    'oblast_n5'
    : {'view': True, 'header':  'область N5', 'dimension': '', 'comment': '', 'group_name': 'Параметры потока в дроссельном блоке',
       'formula': {'expr': '=IF($E$17>4,IF(AND(O58<1,O58>$O$144),"Дозвуковая область","Сверхзвуковая область"),"")',
                   'cell': 'O64'}, 'accuracy': 4},
    'stupeni_n6'
    : {'view': True, 'header':  '№ ступени N6', 'dimension': '', 'comment': '', 'group_name': 'Параметры потока в дроссельном блоке',
    ...
    : {'view': True, 'header':  'Газодинамическая функция расхода, q N6', 'dimension': '', 'comment': '',
       ...
       'formula': {
           ...
           'cell': 'O67'}, 'accuracy': 4},
    'oblast_n6'
    : {'view': True, 'header':  'область N6', 'dimension': '', 'comment': '', 'group_name': 'Параметры потока в дроссельном блоке',
       'formula': {'expr': '=IF($E$17>5,IF(AND(O62<1,O62>$O$144),"Дозвуковая область","Сверхзвуковая область"),"")',
                   'cell': 'O68'}, 'accuracy': 4},
    'stupeni_n7'
    : {'view': True, 'header':  '№ ступени N7', 'dimension': '', 'comment': '', 'group_name': 'Параметры потока в дроссельном блоке',
    ...
    : {'view': True, 'header':  'Газодинамическая функция расхода, q N7', 'dimension': '', 'comment': '',
       ...
       'formula': {
           ...
           'cell': 'O71'}, 'accuracy': 4},
    'oblast_n7'
    : {'view': True, 'header':  'область N7', 'dimension': '', 'comment': '', 'group_name': 'Параметры потока в дроссельном блоке',
       'formula': {'expr': '=IF($E$17>6,IF(AND(O66<1,O66>$O$144),"Дозвуковая область","Сверхзвуковая область"),"")',
                   'cell': 'O72'}, 'accuracy': 4},
    'stupeni_n8'
    : {'view': True, 'header':  '№ ступени N8', 'dimension': '', 'comment': '', 'group_name': 'Параметры потока в дроссельном блоке',
    ...
    : {'view': True, 'header':  'Газодинамическая функция расхода, q N8', 'dimension': '', 'comment': '',
       ...
       'formula': {
           ...
           'cell': 'O75'}, 'accuracy': 4},
    'oblast_n8'
    : {'view': True, 'header':  'область N8', 'dimension': '', 'comment': '', 'group_name': 'Параметры потока в дроссельном блоке',
       'formula': {'expr': '=IF($E$17>7,IF(AND(O70<1,O70>$O$144),"Дозвуковая область","Сверхзвуковая область"),"")',
                   'cell': 'O76'}, 'accuracy': 4},
    'stupeni_n9'
    : {'view': True, 'header':  '№ ступени N9', 'dimension': '', 'comment': '', 'group_name': 'Параметры потока в дроссельном блоке',
    ...
    : {'view': True, 'header':  'Газодинамическая функция расхода, q N9', 'dimension': '', 'comment': '',
       ...
       'formula': {
           ...
           'cell': 'O79'}, 'accuracy': 4},
    'oblast_n9'
    : {'view': True, 'header':  'область N9', 'dimension': '', 'comment': '', 'group_name': 'Параметры потока в дроссельном блоке',
       'formula': {'expr': '=IF($E$17>8,IF(AND(O74<1,O74>$O$144),"Дозвуковая область","Сверхзвуковая область"),"")',
                   'cell': 'O80'}, 'accuracy': 4},
    'stupeni_n10'
    : {'view': True, 'header':  '№ ступени N10', 'dimension': '', 'comment': '', 'group_name': 'Параметры потока в дроссельном блоке',
    ...
    : {'view': True, 'header':  'Газодинамическая функция расхода, q N10', 'dimension': '', 'comment': '',
       ...
       'formula': {
           ...
           'cell': 'O83'}, 'accuracy': 4},
    'oblast_n10'
    : {'view': True, 'header':  'область N10', 'dimension': '', 'comment': '', 'group_name': 'Параметры потока в дроссельном блоке',
    ...
    'stupeni_n2_2'
    : {'view': True, 'header':  '№ ступени N2', 'dimension': '', 'comment': '', 'group_name': 'Расчет геометрических параметров',
    ...
    'stupeni_n3_2'
    : {'view': True, 'header':  '№ ступени N3', 'dimension': '', 'comment': '', 'group_name': 'Расчет геометрических параметров',
    ...
    'stupeni_n4_2'
    : {'view': True, 'header':  '№ ступени N4', 'dimension': '', 'comment': '', 'group_name': 'Расчет геометрических параметров',
    ...
    'stupeni_n5_2'
    : {'view': True, 'header':  '№ ступени N5', 'dimension': '', 'comment': '', 'group_name': 'Расчет геометрических параметров',
    ...
    'stupeni_n6_2'
    : {'view': True, 'header':  '№ ступени N6', 'dimension': '', 'comment': '', 'group_name': 'Расчет геометрических параметров',
    ...
    'stupeni_n7_2'
    : {'view': True, 'header':  '№ ступени N7', 'dimension': '', 'comment': '', 'group_name': 'Расчет геометрических параметров',
    ...
    'stupeni_n8_2'
    : {'view': True, 'header':  '№ ступени N8', 'dimension': '', 'comment': '', 'group_name': 'Расчет геометрических параметров',
    ...
    'stupeni_n9_2'
    : {'view': True, 'header':  '№ ступени N9', 'dimension': '', 'comment': '', 'group_name': 'Расчет геометрических параметров',
    ...
    'stupeni_n10_2'
    : {'view': True, 'header':  '№ ступени N10', 'dimension': '', 'comment': '', 'group_name': 'Расчет геометрических параметров',
    ...
    : {'view': True, 'header':  'Sk -  Площадь выходного сечения корпуса до крышки, кв.м', 'dimension': 'м2', 'comment': '',
       'group_name': 'Аэродинамика',
    ...
    : {'view': True, 'header':  'Незаполненная площадь, кв.м.', 'dimension': 'м2', 'comment': '', 'group_name': 'Аэродинамика',
       'formula': {'expr': '=O136-E33', 'cell': 'O140'}, 'accuracy': 4},
    'gidravlicheskij_diametr_m'
    : {'view': True, 'header':  'Гидравлический диаметр, м', 'dimension': 'м', 'comment': '', 'group_name': 'Аэродинамика',
    ...
    : {'view': True, 'header':  'Pd - Средний скоростной напор на выходе из щелевых каналов', 'dimension': 'м/с', 'comment': '',
       'group_name': 'Аэродинамика',
       'formula': {'expr': '=MAX(O318,O333,O348,O363,O378,O393)', 'cell': 'O143'}, 'accuracy': 4},
    'kriticheskij_perepad_davlenij'
    : {'view': True, 'header':  'Критический перепад давлений', 'dimension': 'МПа', 'comment': '', 'group_name': 'Аэродинамика',
       'formula': {'expr': '=(2/($O$31+1))^($O$31/($O$31-1))', 'cell': 'O144'}, 'accuracy': 4},
    'pk_izbytochnoe_davlenie_pod_kryshkoj_pa'
    : {'view': True, 'header':  'Pk - Избыточное давление под крышкой, Па', 'dimension': 'Па', 'comment': 'Расчет давлений',
    ...
    : {'view': True, 'header':  'Pa - Избыточное давление на выходе из корпуса за ступенью звукопоглощения, Па', 'dimension': 'Па',
    ...
    : {'view': True, 'header':  'pa - Абсолютное давление за ступенью звукопоглощения, Па', 'dimension': 'Па', 'comment': '',
       'group_name': 'Расчет давлений',
    ...
    : {'view': True, 'header':  'Избыточное давление под крышкой, Не может превышать 15000 Па', 'dimension': 'Па', 'comment': '',
       'group_name': 'Расчет давлений',
    ...
    : {'view': True, 'header':  'Избыточное давление на выходе из корпуса за ступенью звукопоглощения, Не может превышать 15000 Па',
    ...
    : {'view': True, 'header':  'wa - Скорость на выходе из корпуса, м/с', 'dimension': 'м/с', 'comment': 'Расчет скоростей',
    ...
    : {'view': True, 'header':  'Динамическая нагрузка на защитную крышку при осевом выхлопе, кН', 'dimension': '', 'comment': '',
    ...
    : {'view': True, 'header':  'Давление за решетками, МПа N0', 'dimension': 'МПа', 'comment': '',
       ...
       'group_name': 'Давление за дроссельными решетками'},
    'y_n0'
    : {'view': True, 'header':  'y N0', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
    ...
    'n0'
    : {'view': True, 'header':  'λ N0', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
       'formula': {'expr': '=0', 'cell': 'O177'}, 'accuracy': 4},
    'n0_2'
    : {'view': True, 'header':  'ε (λ) N0', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
       'formula': {'expr': '=0', 'cell': 'O178'}, 'accuracy': 4},
    'n0_3'
    : {'view': True, 'header':  'τ(λ) N0', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
       'formula': {'expr': '=0', 'cell': 'O179'}, 'accuracy': 4},
    'stupeni_n1_3'
    : {'view': True, 'header':  '№ ступени N1', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
    ...
    'y_n1'
    : {'view': True, 'header':  'y N1', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
    ...
    'n1'
    : {'view': True, 'header':  'λ N1', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
       'formula': {'expr': '=(-1+(1+4*(($O$31-1)/($O$31+1))*O12^2*O182^2)^0.5)/(2*(($O$31-1)/($O$31+1))*O12*O182)',
                   'cell': 'O184'}, 'accuracy': 4},
    'n1_2'
    : {'view': True, 'header':  'ε (λ) N1', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
       'formula': {'expr': '=(1-(($O$31-1)/($O$31+1))*O184^2)^(1/($O$31-1))', 'cell': 'O185'}, 'accuracy': 4},
    'n1_3'
    : {'view': True, 'header':  'τ(λ) N1', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
       'formula': {'expr': '=1-(($O$31-1)/($O$31+1))*O184^2', 'cell': 'O186'}, 'accuracy': 4},
    'stupeni_n2_3'
    : {'view': True, 'header':  '№ ступени N2', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
    ...
    'y_n2'
    : {'view': True, 'header':  'y N2', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
    ...
    'n2'
    : {'view': True, 'header':  'λ N2', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
       'formula': {
           'expr': '=IF(O187="","",(-1+(1+4*(($O$31-1)/($O$31+1))*O12^2*O189^2)^0.5)/(2*(($O$31-1)/($O$31+1))*O12*O189))',
           'cell': 'O191'}, 'accuracy': 4},
    'n2_2'
    : {'view': True, 'header':  'ε (λ) N2', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
       'formula': {'expr': '=IF(O187="","",(1-(($O$31-1)/($O$31+1))*O191^2)^(1/($O$31-1)))', 'cell': 'O192'},
       'accuracy': 4},
    'n2_3'
    : {'view': True, 'header':  'τ(λ) N2', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
       'formula': {'expr': '=IF(O187="","",1-(($O$31-1)/($O$31+1))*O191^2)', 'cell': 'O193'}, 'accuracy': 4},
    'stupeni_n3_3'
    : {'view': True, 'header':  '№ ступени N3', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
    ...
    'y_n3'
    : {'view': True, 'header':  'y N3', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
    ...
    'n3'
    : {'view': True, 'header':  'λ N3', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
       'formula': {
           'expr': '=IF(O194="","",(-1+(1+4*(($O$31-1)/($O$31+1))*O12^2*O196^2)^0.5)/(2*(($O$31-1)/($O$31+1))*O12*O196))',
           'cell': 'O198'}, 'accuracy': 4},
    'n3_2'
    : {'view': True, 'header':  'ε (λ) N3', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
       'formula': {'expr': '=IF(O194="","",(1-(($O$31-1)/($O$31+1))*O198^2)^(1/($O$31-1)))', 'cell': 'O199'},
       'accuracy': 4},
    'n3_3'
    : {'view': True, 'header':  'τ(λ) N3', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
       'formula': {'expr': '=IF(O194="","",1-(($O$31-1)/($O$31+1))*O198^2)', 'cell': 'O200'}, 'accuracy': 4},
    'stupeni_n4_3'
    : {'view': True, 'header':  '№ ступени N4', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
    ...
    'y_n4'
    : {'view': True, 'header':  'y N4', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
    ...
    'n4'
    : {'view': True, 'header':  'λ N4', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
       'formula': {
           'expr': '=IF(O201="","",(-1+(1+4*(($O$31-1)/($O$31+1))*O12^2*O203^2)^0.5)/(2*(($O$31-1)/($O$31+1))*O12*O203))',
           'cell': 'O205'}, 'accuracy': 4},
    'n4_2'
    : {'view': True, 'header':  'ε (λ) N4', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
       'formula': {'expr': '=IF(O201="","",(1-(($O$31-1)/($O$31+1))*O205^2)^(1/($O$31-1)))', 'cell': 'O206'},
       'accuracy': 4},
    'n4_3'
    : {'view': True, 'header':  'τ(λ) N4', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
       'formula': {'expr': '=IF(O201="","",1-(($O$31-1)/($O$31+1))*O205^2)', 'cell': 'O207'}, 'accuracy': 4},
    'stupeni_n5_3'
    : {'view': True, 'header':  '№ ступени N5', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
    ...
    'y_n5'
    : {'view': True, 'header':  'y N5', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
    ...
    'n5'
    : {'view': True, 'header':  'λ N5', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
       'formula': {
           'expr': '=IF(O208="","",(-1+(1+4*(($O$31-1)/($O$31+1))*$O$12^2*O210^2)^0.5)/(2*(($O$31-1)/($O$31+1))*$O$12*O210))',
           'cell': 'O212'}, 'accuracy': 4},
    'n5_2'
    : {'view': True, 'header':  'ε (λ) N5', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
       'formula': {'expr': '=IF(O208="","",(1-(($O$31-1)/($O$31+1))*O212^2)^(1/($O$31-1)))', 'cell': 'O213'},
       'accuracy': 4},
    'n5_3'
    : {'view': True, 'header':  'τ(λ) N5', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
       'formula': {'expr': '=IF(O208="","",1-(($O$31-1)/($O$31+1))*O212^2)', 'cell': 'O214'}, 'accuracy': 4},
    'stupeni_n6_3'
    : {'view': True, 'header':  '№ ступени N6', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
    ...
    'y_n6'
    : {'view': True, 'header':  'y N6', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
    ...
    'n6'
    : {'view': True, 'header':  'λ N6', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
       'formula': {
           'expr': '=IF(O215="","",(-1+(1+4*(($O$31-1)/($O$31+1))*$O$12^2*O217^2)^0.5)/(2*(($O$31-1)/($O$31+1))*$O$12*O217))',
           'cell': 'O219'}, 'accuracy': 4},
    'n6_2'
    : {'view': True, 'header':  'ε (λ) N6', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
       'formula': {'expr': '=IF(O215="","",(1-(($O$31-1)/($O$31+1))*O219^2)^(1/($O$31-1)))', 'cell': 'O220'},
       'accuracy': 4},
    'n6_3'
    : {'view': True, 'header':  'τ(λ) N6', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
       'formula': {'expr': '=IF(O215="","",1-(($O$31-1)/($O$31+1))*O219^2)', 'cell': 'O221'}, 'accuracy': 4},
    'stupeni_n7_3'
    : {'view': True, 'header':  '№ ступени N7', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
    ...
    'y_n7'
    : {'view': True, 'header':  'y N7', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
    ...
    'n7'
    : {'view': True, 'header':  'λ N7', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
       'formula': {
           'expr': '=IF(O222="","",(-1+(1+4*(($O$31-1)/($O$31+1))*$O$12^2*O224^2)^0.5)/(2*(($O$31-1)/($O$31+1))*$O$12*O224))',
           'cell': 'O226'}, 'accuracy': 4},
    'n7_2'
    : {'view': True, 'header':  'ε (λ) N7', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
       'formula': {'expr': '=IF(O222="","",(1-(($O$31-1)/($O$31+1))*O226^2)^(1/($O$31-1)))', 'cell': 'O227'},
       'accuracy': 4},
    'n7_3'
    : {'view': True, 'header':  'τ(λ) N7', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
       'formula': {'expr': '=IF(O222="","",1-(($O$31-1)/($O$31+1))*O226^2)', 'cell': 'O228'}, 'accuracy': 4},
    'stupeni_n8_3'
    : {'view': True, 'header':  '№ ступени N8', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
    ...
    'y_n8'
    : {'view': True, 'header':  'y N8', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
    ...
    'n8'
    : {'view': True, 'header':  'λ N8', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
       'formula': {
           'expr': '=IF(O229="","",(-1+(1+4*(($O$31-1)/($O$31+1))*$O$12^2*O231^2)^0.5)/(2*(($O$31-1)/($O$31+1))*$O$12*O231))',
           'cell': 'O233'}, 'accuracy': 4},
    'n8_2'
    : {'view': True, 'header':  'ε (λ) N8', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
       'formula': {'expr': '=IF(O229="","",(1-(($O$31-1)/($O$31+1))*O233^2)^(1/($O$31-1)))', 'cell': 'O234'},
       'accuracy': 4},
    'n8_3'
    : {'view': True, 'header':  'τ(λ) N8', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
       'formula': {'expr': '=IF(O229="","",1-(($O$31-1)/($O$31+1))*O233^2)', 'cell': 'O235'}, 'accuracy': 4},
    'stupeni_n9_3'
    : {'view': True, 'header':  '№ ступени N9', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
    ...
    'y_n9'
    : {'view': True, 'header':  'y N9', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
    ...
    'n9'
    : {'view': True, 'header':  'λ N9', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
       'formula': {
           'expr': '=IF(O236="","",(-1+(1+4*(($O$31-1)/($O$31+1))*$O$12^2*O238^2)^0.5)/(2*(($O$31-1)/($O$31+1))*$O$12*O238))',
           'cell': 'O240'}, 'accuracy': 4},
    'n9_2'
    : {'view': True, 'header':  'ε (λ) N9', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
       'formula': {'expr': '=IF(O236="","",(1-(($O$31-1)/($O$31+1))*O240^2)^(1/($O$31-1)))', 'cell': 'O241'},
       'accuracy': 4},
    'n9_3'
    : {'view': True, 'header':  'τ(λ) N9', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
       'formula': {'expr': '=IF(O236="","",1-(($O$31-1)/($O$31+1))*O240^2)', 'cell': 'O242'}, 'accuracy': 4},
    'stupeni_n10_3'
    : {'view': True, 'header':  '№ ступени N10', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
    ...
    'y_n10'
    : {'view': True, 'header':  'y N10', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
    ...
    'n10'
    : {'view': True, 'header':  'λ N10', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
       'formula': {
           'expr': '=IF(O243="","",(-1+(1+4*(($O$31-1)/($O$31+1))*$O$12^2*O245^2)^0.5)/(2*(($O$31-1)/($O$31+1))*$O$12*O245))',
           'cell': 'O247'}, 'accuracy': 4},
    'n10_2'
    : {'view': True, 'header':  'ε (λ) N10', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
       'formula': {'expr': '=IF(O243="","",(1-(($O$31-1)/($O$31+1))*O247^2)^(1/($O$31-1)))', 'cell': 'O248'},
       'accuracy': 4},
    'n10_3'
    : {'view': True, 'header':  'τ(λ) N10', 'dimension': '', 'comment': '', 'group_name': 'Давление за дроссельными решетками',
    ...
    'pa_pa'
    : {'view': True, 'header':  'pa, Па', 'dimension': 'Па', 'comment': '', 'group_name': 'Расчет аэродинамики для кольцевых каналов',
    ...
    : {'view': True, 'header':  'Pi3 - Давление перед ступенью звукопоглощения, Па', 'dimension': 'Па', 'comment': 'ф. (5.175):',
       'group_name': 'Расчет аэродинамики для кольцевых каналов',
    ...
    : {'view': True, 'header':  'k - Коэффициент адиабаты', 'dimension': '', 'comment': '', 'group_name': 'Расчет выхлопной части',
    ...
    : {'view': True, 'header':  'Т - Температура среды, К', 'dimension': '°С', 'comment': '', 'group_name': 'Расчет выхлопной части',
    ...
    : {'view': True, 'header':  'D - Внутренний диаметр корпуса ступени звукопоглощения, м', 'dimension': 'м', 'comment': '',
       'group_name': 'Расчет выхлопной части',
    ...
    : {'view': True, 'header':  'hk - Осевое расстояние от выходного сечения корпуса  до крышки, м', 'dimension': 'м', 'comment': '',
       'group_name': 'Расчет выхлопной части',
       'formula': {'expr': '=E35', 'cell': 'O281'}, 'accuracy': 4},
    'sk_ploschad_vyhodnogo_secheniya_kanala_korpusa_do_kryshki_m2'
    : {'view': True, 'header':  'Sk - Площадь выходного сечения канала корпуса до крышки, м2', 'dimension': 'м2', 'comment': '',
       'group_name': 'Расчет выхлопной части',
    ...
    : {'view': True, 'header':  'pa - Абсолютное давление за ступенью звукопоглощения, Па', 'dimension': 'Па', 'comment': 'ф. (5.213)',
       'group_name': 'Расчет выхлопной части',
    ...
    : {'view': True, 'header':  'Wa - Мощность шума на выходе из корпуса, Вт', 'dimension': 'Вт', 'comment': 'ф. (5.218)',
       'group_name': 'Расчет выхлопной части',
    ...
    : {'view': True, 'header':  'Lwa -УЗМ, генерируемый истечением из корпуса, дБ', 'dimension': 'дБ', 'comment': 'ф. (5.57)',
       'group_name': 'Расчет выхлопной части',
    ...
    : {'view': True, 'header':  'Динамическая нагрузка на защитную крышку при боковом выхлопе, кН', 'dimension': '', 'comment': '',
       'group_name': 'Динамические нагрузки',
    ...
    'ds_n1'
    : {'view': True, 'header':  'ds N1', 'dimension': '', 'comment': '', 'group_name': 'Расчет аэродинамики для кольцевых каналов',
    ...
    'ds_n2'
    : {'view': True, 'header':  'ds N2', 'dimension': '', 'comment': '', 'group_name': 'Расчет аэродинамики для кольцевых каналов',
    ...
    'ds_n3'
    : {'view': True, 'header':  'ds N3', 'dimension': '', 'comment': '', 'group_name': 'Расчет аэродинамики для кольцевых каналов',
    ...
    'ds_n4'
    : {'view': True, 'header':  'ds N4', 'dimension': '', 'comment': '', 'group_name': 'Расчет аэродинамики для кольцевых каналов',
    ...
    'ds_n5'
    : {'view': True, 'header':  'ds N5', 'dimension': '', 'comment': '', 'group_name': 'Расчет аэродинамики для кольцевых каналов',
    ...
    'ds_n6'
    : {'view': True, 'header':  'ds N6', 'dimension': '', 'comment': '', 'group_name': 'Расчет аэродинамики для кольцевых каналов',
    ...
    : {'view': True, 'header':  'Атмосферное давление, Па', 'dimension': 'Па', 'comment': 'Стандартное атмосферное давление (Па)',
