...
class item_parse_prices(BaseModel):
...
class data_parse_prices(BaseModel):
    data_nomens: List[item_parse_prices]

class data_get_file(BaseModel):
    path_file: Union[str, None] = None,

class data_get_files(BaseModel):
