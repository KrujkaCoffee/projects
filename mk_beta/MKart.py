...
class mywindow(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        if not self.USER_CONFIG.is_developer:
            ...
            CQT.add_sub_action_menu(self,self.ui,'menu_2', 'Перегрузить список полей(из таб-ц в info_fields_kpl)', KPL.update_db_info_fields_kpl)#
            CQT.add_sub_action_menu(self,self.ui,'menu_2', 'Заполнить новые таблицы строками КПЛ', KPL.fill_id_kpl_into_new_tbls_plan)#
    ...
    def check_zaversheni_naruady(self, mkarti: list) -> bool:
        ...
        alias = CMS.get_plan_otk_alias_by_poki(self.place.poki)
        for mk in list_mk:
