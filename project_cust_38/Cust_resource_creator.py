...
class GruopNomenData(ObjsData):
    NAME_ERP_OBJ = 'ГруппаНоменклатуры'
    if 'свойства':
...
class Nomenclature():
    ...
    def check_data(self)->tuple[bool,list[str]]:
        ...
        if not isinstance(self.СтавкаНДС,NDS_rates):
            ...
            succ = False
        if not isinstance(self.ГруппаАналитическогоУчета,NomenAnalysisGroups) and self.ГруппаАналитическогоУчета is not None:
            list_err.append(f'not isinstance(self.ГруппаАналитическогоУчета,NomenAnalysisGroups)')
            succ = False
        if not isinstance(self.ГруппаФинансовогоУчета,FinancialAccountingGroup) and self.ГруппаФинансовогоУчета is not None:
    ...
    def create_nomen(self):
        ...
        if self.ГруппаАналитическогоУчета:
            dict_nomen['ГруппаАналитическогоУчета'] =  self.ГруппаАналитическогоУчета.ref_key
        if self.ГруппаФинансовогоУчета:
            dict_nomen['ГруппаФинансовогоУчета'] =  self.ГруппаФинансовогоУчета.ref_key
