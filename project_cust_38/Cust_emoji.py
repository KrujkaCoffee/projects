...
class ПерсоналРоли:
    ...
    workday: ClassVar[EmojiItem] = EmojiItem('💼', 'workday', 'personnel', 'Будний день')
    weekend: ClassVar[EmojiItem] = EmojiItem('🛋️', 'weekend', 'personnel', 'Выходной день')
    holiday: ClassVar[EmojiItem] = EmojiItem('🎈', 'holiday', 'personnel', 'Праздничный день')
    server: ClassVar[EmojiItem] = EmojiItem('🗄️', 'server', 'personnel', 'Сервер')
    local_machine: ClassVar[EmojiItem] = EmojiItem('🖥️', 'local_machine', 'personnel', 'Рабочая станция')
    active: ClassVar[EmojiItem] = EmojiItem('👷', 'active', 'personnel', 'Работает')
    fired: ClassVar[EmojiItem] = EmojiItem('❌', 'fired', 'personnel', 'Уволен')
...
class ДокументыДанные:
    ...
    move_left_border: ClassVar[EmojiItem] = EmojiItem('↤', 'move_left_border', 'documents', 'Левая граница')
    move_right_border: ClassVar[EmojiItem] = EmojiItem('↦', 'move_right_border', 'documents', 'Правая граница')
