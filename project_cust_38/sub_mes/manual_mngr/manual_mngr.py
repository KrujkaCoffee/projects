...
class CentralWindow(CQT.QtWidgets.QMainWindow):
    ...
    def apply_subj(self,subject_mode:str=None):
        ...
        self.NAME_MODULE_BASE = f'Менеджер документации v{self.VER}{subject_mode_str}'
        ...
        if DTCLS.app_self:
            CFG.BaseSubWindow.window_binding(self, F.name_of_caller_file(), DTCLS.app_self) #ВАЖНО до init_data
