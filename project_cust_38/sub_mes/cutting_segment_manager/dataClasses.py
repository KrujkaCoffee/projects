...
if TYPE_CHECKING:
    ...
    from sub_classes import ConnectionDSE, ConnectionsDSE
...
class data_app(SingletonMeta):
    ...
    app_self = None
    template_xml: list[dict]|None = None
    connection_dse:ConnectionDSE|None = None
    connections_dse:ConnectionsDSE|None = None
